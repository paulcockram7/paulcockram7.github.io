...
* **04 Loans**
	...
	- [Starter Scoring]({{ site.baseurl }}/15finance/pics/moneyquiz03scoring.pdf ){:target="_blank"}   (Use **Right Mouse Button** and **Save As** to save this to your area) 

	- [Task 1 Answers]({{ site.baseurl }}/15finance/loans/task01 answers.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) Pay Day Loan Interest calculations

	- [Task 2 Answers]({{ site.baseurl }}/15finance/loans/task02 answers.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) Assorted Loan Interest calculations

	- [Lesson Powerpoint]({{ site.baseurl }}/15finance/loans.pptx )  (Use **Right Mouse Button** and **Save As** to save this to your area) About Loans
