...
![Alt textl]({{ site.baseurl }}/15finance/loans/paydayloans.jpg " ")
...
* [Task 2]({{ site.baseurl }}/15finance/loans/task02.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) Assorted Loan Interest calculations

![Alt textl]({{ site.baseurl }}/15finance/loans/task02.jpg " ")

* Visit the loan websites in the document and find out what their Representative APR rate is.

* Then using the same Loan Calculator site as above determine the amount of interest you will pay for each company

* [Payday Loan Repayment Calculator](http://www.bbc.co.uk/consumer/24746198 " "){:target="_blank"} Web Site same as above

* **Task 3**

	- Create a new word document **loancriteria**
...
* [PayDay Loans Quiz 1](https://www.cashfloat.co.uk/blog/loans-lenders/payday-loans-quiz/ " "){:target="_blank"} You will probably have to guess some of the answers 


* [PayDay Loans Quiz 2](http://money.howstuffworks.com/personal-finance/banking/payday-loans-quiz.htm " "){:target="_blank"} You will probably have to guess some of the answers 
...
![Alt textl]({{ site.baseurl }}/15finance/vat/vatimghdr.jpg " ")

![Alt textl]({{ site.baseurl }}/15finance/vat/taxwordsearch01img.jpg " ")

* [Starter]({{ site.baseurl }}/15finance/vat/taxwordsearch01.jpg ){:target="_blank"}  (Use **Right Mouse Button** and **Save As** to save this to your area) Word Search

* [Video]({{ site.baseurl }}/15finance/vat/What is VAT.mp4 ){:target="_blank"} VAT Introduction

![Alt textl]({{ site.baseurl }}/15finance/vat/What is VAT.jpg " ")

* [Task 11]({{ site.baseurl }}/15finance/vat/what tax.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) Research Tax values

![Alt textl]({{ site.baseurl }}/15finance/vat/task11.jpg " ")

* Use the Internet to reearch and fill in the missing items in the tax lists. (This will be the ones in black)

* **Task 12**

* This consists of the 2 parts below (part A and part B)

* Work out the VAT and the Cost/Price

	- [Task 12A]({{ site.baseurl }}/15finance/vat/task12a.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) From the Price work out the VAT and the Total Cost

	- ![Alt textl]({{ site.baseurl }}/15finance/vat/task12a.jpg " ")

	- [Task 12B]({{ site.baseurl }}/15finance/vat/task12b.docx )  (Use **Right Mouse Button** and **Save As** to save this to your area) From the Total Cost work out the VAT and the Price

	- ![Alt textl]({{ site.baseurl }}/15finance/vat/task12b.jpg " ")

* [VAT Quiz](http://www.taxpayersalliance.com/the_tpa_vat_quiz " "){:target="_blank"} See which items HAVE VAT and which DO NOT

![Alt textl]({{ site.baseurl }}/15finance/vat/vatquiz01.jpg " ")
...
* **04 Loans**
	...
	- [Starter Scoring]({{ site.baseurl }}/15finance/loans/moneyquiz03scoring.zip ){:target="_blank"}   (Use **Right Mouse Button** and **Save As** to save this to your area) 

	- [Task 1 Answers]({{ site.baseurl }}/15finance/loans/task01 answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) Pay Day Loan Interest calculations

	- [Task 2 Answers]({{ site.baseurl }}/15finance/loans/task02 answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) Assorted Loan Interest calculations

	- [Lesson Powerpoint]({{ site.baseurl }}/15finance/loans/04 loans.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) About Loans

* **05 VAT**

	- [Starter Answers]({{ site.baseurl }}/15finance/vat/taxwordsearch01 answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) Word Search Answers

	- [Task 11 Answers]({{ site.baseurl }}/15finance/vat/what tax answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) Research Tax values

	- Task 12

		- [Task 12A Answers]({{ site.baseurl }}/15finance/vat/task12a answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) From the Price work out the VAT and the Total Cost

		- [Task 12B Answers]({{ site.baseurl }}/15finance/vat/task12b answers.zip )  (Use **Right Mouse Button** and **Save As** to save this to your area) From the Total Cost work out the VAT and the Price
